    ...
    public static void main(String[] args) {
        try (BufferedReader br = new BufferedReader(new FileReader("src/main/java/A2016/Day3/input.txt"))) {
            ...
            while ((line = br.readLine()) != null) {
                String[] lstcote = line.split("\\s+");

                triangle1[compteur] = Integer.parseInt(lstcote[1]);
                triangle2[compteur] = Integer.parseInt(lstcote[2]);
                triangle3[compteur] = Integer.parseInt(lstcote[3]);
